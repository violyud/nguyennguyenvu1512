                        ...
                        <div className="content">
                            ...
                            <div className="right">
                                ...
                                <div className="overview">
                                    <div className="heading">Tổng quan</div>
                                ...
                                {data.release_date && (
                                    <div className="infoItem">
                                        <span className="text bold">Ngày phát hành: {""}</span>
                                        <span className="text">{dayjs(data.release_date).format("MMM D, YYYY")}</span>
                                    </div>
                                ) }
                                {data.runtime && (
                                    <div className="infoItem">
                                        <span className="text bold">Thời gian chạy: {""}</span>
                                ...
                                {director?.length>0 && (
                                    <div className="info">
                                        <span className="text bold">Giám đốc:{" "}</span>
                                ...
                                {writer?.length>0 && (
                                    <div className="info">
                                        <span className="text bold">Người viết:{" "}</span>
                                ...
                                {data?.created_by?.length>0 && (
                                    <div className="info">
                                        <span className="text bold">Người sáng tạo:{" "}</span>
